...
public final class DocumentCreateFixture implements Fixture {
    ...
    public @NonNull String getRequestUrl() {
        return "/rest/v1/documents";
    }

    public @Nullable Object getPostBody() {
        return DocumentRequest.builder().title("something").build();
    }
